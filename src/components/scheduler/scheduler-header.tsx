...
export function SchedulerHeader() {
  ...
  const filters = scheduler.filters;
  const setFilters = scheduler.setFilters;
  const viewMode = scheduler.viewMode;
  const setViewMode = scheduler.setViewMode;
  const onExport = scheduler.onExport;
  const monthOptions = scheduler.monthOptions ?? [];
  const serviceOptions = scheduler.serviceOptions ?? [];
  const selectedMonthLabel = scheduler.selectedMonthLabel ?? '';
